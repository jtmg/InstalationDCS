...
docker pull 34.250.203.252:8082/mysql
docker pull 34.250.203.252:8082/mongo

docker run --name mysql -d -it -p 3306:3306 34.250.203.252:8083/mysql
docker run --name mongo -d -it -p 27017:27017 34.250.203.252:8083/mongo